...
Background: Setting base URL
  ...
  Scenario: Verify adding, updating and deleting a announcement
    ...
    When I send "POST" request to annoucement resource "rest/announcements" 
    Then I verify status code "200" for annoucement end point response 
    And I extract annoucement id from response body
    Given I set Headers with API key, "ROLE_ADMIN" authorization for announcements
    When I send "GET" request to annoucement resource "rest/announcements" 
    ...
    Then I verify status code "200" for annoucement end point response 
    And I validate response body has updated annoucement information
    Given I set Headers with API key, "ROLE_ADMIN" authorization for announcements 
    ...
    Then I verify status code "404" for annoucement end point response 
